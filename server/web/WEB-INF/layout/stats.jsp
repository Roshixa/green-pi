        ...
        <div class="ui dropdown item green" tabindex="0">
          ...
          <div class="menu">
            ...
            <c:forEach var="plant" items="${plants}">
              <a class="item" href="live/
              <c:out value="${plant.hash}"/>
              ">
              ...
              <tbody>
                <c:forEach var="plant" items="${plants}" varStatus="loop">
                  ...
                  <c:choose>
                    ...
                    <c:otherwise>
                      <td>
                        <c:out value="${reading.moisture}"/>
                      </td>
                      <td>
                        <c:out value="${reading.luminosity}"/>
                      </td>
                      <td>
                        <c:out value="${reading.humidity}"/>
                      </td>
                      <td>
                        <c:out value="${reading.temperature}"/>
                      </td>
                    </c:otherwise>
                  </c:choose>
                </c:forEach>
